...
class PodDisruptionBudgetSpec(BaseModel):
    ...
    minAvailable: Optional[intstr.IntOrStringModel] = Field(
        None,
...
class PodDisruptionBudgetStatus(BaseModel):
    ...
    desiredHealthy: int = Field(..., description="minimum desired number of healthy pods")
    disruptedPods: Optional[dict[str, v1.TimeModel6]] = Field(
        None,
...
class PodDisruptionBudget(BaseModel):
    ...
    metadata: v1.ObjectMetaModel6 = Field(
        {},
...
class PodDisruptionBudgetList(BaseModel):
    ...
    metadata: v1.ListMetaModel6 = Field(
        {},
        description="Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
    )
