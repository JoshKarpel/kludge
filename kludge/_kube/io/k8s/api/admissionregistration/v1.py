...
class ServiceReference(BaseModel):
    ...
    namespace: str = Field(..., description="`namespace` is the namespace of the service. Required")
...
class MutatingWebhook(BaseModel):
    ...
    namespaceSelector: Optional[v1.LabelSelectorModel] = Field(
        None,
    ...
    objectSelector: Optional[v1.LabelSelectorModel] = Field(
        None,
...
class MutatingWebhookConfiguration(BaseModel):
    ...
    metadata: v1.ObjectMetaModel2 = Field(
        {},
...
class MutatingWebhookConfigurationList(BaseModel):
    ...
    metadata: v1.ListMetaModel2 = Field(
        {},
