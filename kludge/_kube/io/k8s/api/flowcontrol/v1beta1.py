...
class FlowSchemaCondition(BaseModel):
    ...
    lastTransitionTime: v1.TimeModel13 = Field(
        {},
    ...
    type: Optional[str] = Field(None, description="`type` is the type of the condition. Required.")
...
class LimitedPriorityLevelConfiguration(BaseModel):
    ...
    assuredConcurrencyShares: int = Field(
        0,
    ...
    limitResponse: LimitResponse = Field(
        {},
...
class Subject(BaseModel):
    ...
    user: Optional[UserSubject] = Field(None, description="`user` matches based on username.")
...
class PriorityLevelConfiguration(BaseModel):
    ...
    metadata: v1.ObjectMetaModel13 = Field(
        {},
    ...
    status: PriorityLevelConfigurationStatus = Field(
        {},
...
class PriorityLevelConfigurationList(BaseModel):
    ...
    metadata: v1.ListMetaModel11 = Field(
        {},
        description="`metadata` is the standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
    )
...
class FlowSchemaList(BaseModel):
    ...
    items: list[FlowSchema] = Field(..., description="`items` is a list of FlowSchemas.")
    kind: Optional[str] = Field(
        None,
        description="Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
    )
