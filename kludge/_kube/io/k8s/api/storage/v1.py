...
class CSIStorageCapacity(BaseModel):
    ...
    capacity: Optional[resource.QuantityModel] = Field(
        None,
    ...
    maximumVolumeSize: Optional[resource.QuantityModel] = Field(
        None,
    ...
    nodeTopology: Optional[v1.LabelSelectorModel1] = Field(
        None,
...
class StorageClass(BaseModel):
    allowVolumeExpansion: Optional[bool] = Field(
        None, description="AllowVolumeExpansion shows whether the storage class allow volume expand"
    )
...
class VolumeAttachmentSource(BaseModel):
    inlineVolumeSpec: Optional[v1_1.PersistentVolumeSpecModel] = Field(
        None,
...
class VolumeAttachmentSpec(BaseModel):
    ...
    nodeName: str = Field(..., description="The node that the volume should be attached to.")
