...
class DaemonSetStatus(BaseModel):
    ...
    observedGeneration: Optional[int] = Field(
        None, description="The most recent generation observed by the daemon set controller."
    )
    updatedNumberScheduled: Optional[int] = Field(
        None, description="The total number of nodes that are running updated daemon pod"
    )
...
class RollingUpdateDaemonSet(BaseModel):
    maxSurge: Optional[intstr.IntOrStringModel2] = Field(
        None,
    ...
    maxUnavailable: Optional[intstr.IntOrStringModel2] = Field(
        None,
...
class DaemonSetUpdateStrategy(BaseModel):
    rollingUpdate: Optional[RollingUpdateDaemonSet] = Field(
        None, description='Rolling update config params. Present only if type = "RollingUpdate".'
    )
    type: Optional[str] = Field(
        None,
...
class DaemonSetSpec(BaseModel):
    ...
    selector: v1.LabelSelectorModel8 = Field(
        ...,
...
class DeploymentSpec(BaseModel):
    ...
    paused: Optional[bool] = Field(None, description="Indicates that the deployment is paused.")
...
class StatefulSetSpec(BaseModel):
    ...
    volumeClaimTemplates: Optional[List[v1_1.PersistentVolumeClaimModel]] = Field(
        None,
...
class DeploymentList(BaseModel):
    ...
    items: List[Deployment] = Field(..., description="Items is the list of Deployments.")
    kind: Optional[str] = Field(
        None,
        description="Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
    )
...
class StatefulSetList(BaseModel):
    ...
    items: List[StatefulSet] = Field(..., description="Items is the list of stateful sets.")
    kind: Optional[str] = Field(
        None,
        description="Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
    )
