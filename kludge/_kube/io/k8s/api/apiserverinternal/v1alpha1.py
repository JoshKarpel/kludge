...
class ServerStorageVersion(BaseModel):
    ...
    apiServerID: Optional[str] = Field(None, description="The ID of the reporting API server.")
...
class StorageVersionCondition(BaseModel):
    ...
    lastTransitionTime: v1.TimeModel19 = Field(
...
class StorageVersion(BaseModel):
    ...
    metadata: v1.ObjectMetaModel19 = Field({}, description="The name is <group>.<resource>.")
...
class StorageVersionList(BaseModel):
    ...
    metadata: v1.ListMetaModel17 = Field(
        {},
