...
class IngressStatus(BaseModel):
    ...
    loadBalancer: v1.LoadBalancerStatusModel = Field(
...
class NetworkPolicyPort(BaseModel):
    ...
    port: Optional[intstr.IntOrStringModel3] = Field(
        None,
...
class IngressBackend(BaseModel):
    ...
    resource: Optional[v1.TypedLocalObjectReferenceModel2] = Field(
        None,
...
class IngressClass(BaseModel):
    ...
    metadata: v1_1.ObjectMetaModel23 = Field(
        {},
        description="Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
    )
    spec: IngressClassSpec = Field(
        {},
...
class IngressClassList(BaseModel):
    ...
    items: list[IngressClass] = Field(..., description="Items is the list of IngressClasses.")
    kind: Optional[str] = Field(
        None,
        description="Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
    )
    metadata: v1_1.ListMetaModel21 = Field({}, description="Standard list metadata.")
...
class NetworkPolicyPeer(BaseModel):
    ...
    namespaceSelector: Optional[v1_1.LabelSelectorModel9] = Field(
        None,
        description="Selects Namespaces using cluster-scoped labels. This field follows standard label selector semantics; if present but empty, it selects all namespaces.\n\nIf PodSelector is also set, then the NetworkPolicyPeer as a whole selects the Pods matching PodSelector in the Namespaces selected by NamespaceSelector. Otherwise it selects all Pods in the Namespaces selected by NamespaceSelector.",
    )
    podSelector: Optional[v1_1.LabelSelectorModel9] = Field(
        None,
...
class NetworkPolicySpec(BaseModel):
    ...
    podSelector: v1_1.LabelSelectorModel9 = Field(
        ...,
...
class IngressList(BaseModel):
    ...
    metadata: v1_1.ListMetaModel21 = Field(
        {},
        description="Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
    )
...
class NetworkPolicy(BaseModel):
    ...
    spec: NetworkPolicySpec = Field(
        {}, description="Specification of the desired behavior for this NetworkPolicy."
    )
    status: NetworkPolicyStatus = Field(
        {},
...
class NetworkPolicyList(BaseModel):
    ...
    items: list[NetworkPolicy] = Field(..., description="Items is a list of schema objects.")
    kind: Optional[str] = Field(
        None,
        description="Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
    )
