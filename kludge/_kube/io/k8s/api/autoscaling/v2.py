...
class HorizontalPodAutoscalerCondition(BaseModel):
    ...
    lastTransitionTime: v1.TimeModel7 = Field(
        {},
...
class MetricTarget(BaseModel):
    ...
    averageValue: Optional[resource.QuantityModel2] = Field(
        None,
    ...
    value: Optional[resource.QuantityModel2] = Field(
...
class MetricIdentifier(BaseModel):
    ...
    selector: Optional[v1.LabelSelectorModel4] = Field(
        None,
...
class HorizontalPodAutoscalerStatus(BaseModel):
    ...
    lastScaleTime: Optional[v1.TimeModel7] = Field(
        None,
...
class HorizontalPodAutoscaler(BaseModel):
    ...
    metadata: v1.ObjectMetaModel7 = Field(
        {},
...
class HorizontalPodAutoscalerList(BaseModel):
    ...
    metadata: v1.ListMetaModel7 = Field({}, description="metadata is the standard list metadata.")
