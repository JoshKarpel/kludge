...
class LeaseSpec(BaseModel):
    ...
    holderIdentity: Optional[str] = Field(
        None, description="holderIdentity contains the identity of the holder of a current lease."
    )
...
class Lease(BaseModel):
    ...
    metadata: v1.ObjectMetaModel14 = Field(
        {},
...
class LeaseList(BaseModel):
    ...
    metadata: v1.ListMetaModel12 = Field(
        {},
