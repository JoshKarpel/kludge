...
class UserInfo(BaseModel):
    ...
    username: Optional[str] = Field(
        None, description="The name that uniquely identifies this user among all active users."
    )
...
class TokenReviewStatus(BaseModel):
    ...
    authenticated: Optional[bool] = Field(
        None, description="Authenticated indicates that the token was associated with a known user."
    )
